...
$templateCache.put("{widgetsPath}/jb-zconnect-widget-company/src/templates/insights.html","<div class={{insights.config.class}} style=\"height: {{insights.config.height}}px !important;\"><nvd3 options=insights.options data=insights.data></nvd3><div class=\"col-lg-12 col-sm-12 col-xs-12\"><div class=row></div></div></div>");
