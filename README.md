# adf-widget-jb-zconnect-widget-company

jb-zconnect-widget-company widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-jb-zconnect-widget-company
...
```html
<script type="text/javascript" src="path/to/jb-zconnect-widget-company.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.jb-zconnect-widget-company']);
```
